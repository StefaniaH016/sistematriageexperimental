...
public class AsistenciaIAService {
    ...
    private SugerenciaIAResponseDTO aplicarReglasNegocio(SolicitudResponseDTO solicitud) {
        ...
        if (content.contains("semestre") && (content.contains("cancel") || content.contains("retir") || content.contains("abandon"))) {
            tipoSugerido = TipoSolicitud.CANCELACION_SEMESTRE.name();
            prioridadSugerida = Prioridad.ALTA;
        }
        // Modificación de matrícula
        else if ((content.contains("modifica") || content.contains("cambio")) && (content.contains("matrícula") || content.contains("matricula"))) {
        ...
        else if ((content.contains("cancel") || content.contains("retir")) && (content.contains("asignatura") || content.contains("materia"))) {
            tipoSugerido = TipoSolicitud.CANCELACION_ASIGNATURAS.name();
        }
        // Homologación
        else if (content.contains("homologa") || content.contains("reconocimiento de crédito") || content.contains("reconocimiento de credito")) {
            tipoSugerido = TipoSolicitud.HOMOLOGACION.name();
        }
        // Examen supletorio
        else if (content.contains("supletorio") || (content.contains("examen") && content.contains("perdi")) || content.contains("examen supletorio")) {
        ...
        else if (content.contains("apoyo económico") || content.contains("apoyo economico") || content.contains("subsidio") || content.contains("dificultad econ")) {
        ...
        // Apoyo psicosocial
        else if (content.contains("psicolog") || content.contains("bienestar") || content.contains("ansiedad") || content.contains("estrés") || content.contains("salud mental")) {
        ...
        else if (content.contains("práctica") || content.contains("practica") || content.contains("pasantía") || content.contains("pasantia")) {
        ...
        else if (content.contains("transferencia") || content.contains("cambio de programa") || content.contains("cambio de carrera")) {
            tipoSugerido = TipoSolicitud.TRANSFERENCIA_INTERNA.name();
        }
        // Proceso disciplinario
        else if (content.contains("disciplinar") || content.contains("apelación") || content.contains("apelacion") || content.contains("sanc")) {
        ...
        if (content.contains("urgente") || content.contains("auxilio") || content.contains("inmediato") || content.contains("inminente")) {
            prioridadSugerida = Prioridad.ALTA;
        }
        ...
        return SugerenciaIAResponseDTO.builder()
                ...
                .sugerenciaRespuesta("Estimado estudiante, hemos recibido su solicitud sobre " + descripcionTipo + ". Estaremos procesándola pronto.")
